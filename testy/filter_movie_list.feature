...
Background: movies have been added to database
  ...
  | Blade Runner 	    | PG     |   1982-06-25 |
  | Alien                   | R      |   1979-05-25 |
  | THX-1138                | R      |   1971-03-11 |
...
Scenario: no checkboxes selected
  ...
  When I uncheck the following ratings: NC-17, PG, R, PG-13, G
  And I press "ratings_submit"
...
Scenario: all checkboxes selected
  ...
  When I check the following ratings: NC-17, PG, R, PG-13, G
  And I press "ratings_submit"
  Then I should be on the home page
